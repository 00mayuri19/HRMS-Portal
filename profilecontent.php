...
<body>
   ...
   <div class="container">
     ...
     <h1 class="h">  PROFILE</h1>
      ...
      <button class="buttons"><a href="mass_onboarding1.php">My Resume</a></button>
   ...
   <main>
       <div class="sec3">
        ...
        <a href="professional.html">Professional Info</a>
            ...
            <div style="margin-top:30px" style="padding-left:30px" class="section">
                <div class="row g-0">
                    ...
                    <div class="col-7 col-md-9 "style="background-color:var(--background-color1)">
                     ...
                     <div class="col-5 col-md-3 "style="background-color:var(--background-color1)">
                      <div class="p-2" style="color:var(--text-color)">Father's Name</div>
                    </div>
                    <div class="col-7 col-md-9 "style="background-color:var(--background-color1)">
                      <div class="p-2" style="color:var(--text-color)">Mr.Amit Gupta</div>
                    </div>
                    <div class="col-5 col-md-3 "style="background-color:var(--background-color1)">
                      <div class="p-2" style="color:var(--text-color)">Emergency Phone</div>
                    </div>
                    <div class="col-7 col-md-9 "style="background-color:var(--background-color1)">
                      <div class="p-2" style="color:var(--text-color)">XXXXXXXXXXXX</div>
                    </div>
                    <div class="col-5 col-md-3 "style="background-color:var(--background-color1)">
                      <div class="p-2" style="color:var(--text-color)">Joined on</div>
                    </div>
                    <div class="col-7 col-md-9 "style="background-color:var(--background-color1)">
                      <div class="p-2" style="color:var(--text-color)">XX/XX/XXXX</div>
                    </div>
                    <div class="col-5 col-md-3 "style="background-color:var(--background-color1)">
                      <div class="p-2" style="color:var(--text-color)"> Alternate Email</div>
                    </div>
                    <div class="col-7 col-md-9 "style="background-color:var(--background-color1)">
                      <div class="p-2" style="color:var(--text-color)">admin.cct@gmail.com</div>
                    </div>
                     <div class="col-5 col-md-3" style="background-color:var(--background-color1)">
                      <div class="p-2" style="color:var(--text-color)">Address</div>
                    </div>
                    <div class="col-7 col-md-9" style="background-color:var(--background-color1)">
                      <div class="p-2"style="color:var(--text-color)">Delhi,India</div>
                    </div>
                    <div class="col-5 col-md-3 "style="background-color:var(--background-color1)">
                      <div class="p-2" style="color:var(--text-color)">Education</div>
                    </div>
                    <div class="col-7 col-md-9 "style="background-color:var(--background-color1)">
                      <div class="p-2" style="color:var(--text-color)">BCA(2nd year)</div>
                    </div>
                    <div class="col-5 col-md-3 "style="background-color:var(--background-color1)">
                      <div class="p-2" style="color:var(--text-color)">Aadhar No:</div>
                    </div>
                    <div class="col-7 col-md-9 "style="background-color:var(--background-color1)">
                      <div class="p-2" style="color:var(--text-color)">XXXXXXXXXXXX</div>
                    </div>
                    <div class="col-5 col-md-3 "style="background-color:var(--background-color1)">
                      <div class="p-2" style="color:var(--text-color)"> 10th Percentage</div>
                    </div>
                    <div class="col-7 col-md-9 "style="background-color:var(--background-color1)">
                      <div class="p-2" style="color:var(--text-color)">90%</div>
                    </div>
                     <div class="col-5 col-md-3" style="background-color:var(--background-color1)">
                      <div class="p-2" style="color:var(--text-color)">!2th Percentage</div>
                    </div>
                    <div class="col-7 col-md-9" style="background-color:var(--background-color1)">
                      <div class="p-2"style="color:var(--text-color)">85%</div>
                    </div>
                    <div class="col-5 col-md-3 "style="background-color:var(--background-color1)">
                      <div class="p-2" style="color:var(--text-color)">Pan No</div>
                    </div>
                    <div class="col-7 col-md-9 "style="background-color:var(--background-color1)">
                      <div class="p-2" style="color:var(--text-color)">XXXXXXXXXX</div>
                    </div>
                    <div class="col-5 col-md-3 "style="background-color:var(--background-color1)">
                      <div class="p-2" style="color:var(--text-color)">Blood Group</div>
                    </div>
                    <div class="col-7 col-md-9 "style="background-color:var(--background-color1)">
                      <div class="p-2" style="color:var(--text-color)">B positive</div>
                    </div>
                    <div class="col-5 col-md-3 "style="background-color:var(--background-color1)">
                      <div class="p-2" style="color:var(--text-color)">Bachelor's degree</div>
                    </div>
                    <div class="col-7 col-md-9 "style="background-color:var(--background-color1)">
                      <div class="p-2" style="color:var(--text-color)">XYZ</div>
                    </div>
                     <div class="col-5 col-md-3" style="background-color:var(--background-color1)">
                      <div class="p-2" style="color:var(--text-color)">Master's Degree</div>
                    </div>
                    <div class="col-7 col-md-9" style="background-color:var(--background-color1)">
                      <div class="p-2"style="color:var(--text-color)">XYZ</div>
                    </div>
    ...
    function getCookie1(name) {
            ...
            function toggleTheme() {
                ...
                if (currentTheme === "dark") {
                    ...
                    //massonboarding.php(for uploading resume)
     <?php
include "config1.php"; // Include the database connection script
			...
			<strong>Fill UserName and Upload PDF</strong>
				<form method="post" enctype="multipart/form-data">
					...
					<div class="form-input py-2">
						...
						<div class="form-group">
							<input type="submit"
								class="btnRegister" name="submit" value="upload">
						</div>
					</div>
				</form>
			</div>		 
