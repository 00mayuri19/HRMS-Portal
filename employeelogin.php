<?php
session_start();
$admin_email = "employee@calanjiyam.com";
$admin_password = "employee1212";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($email === $admin_email && $password === $admin_password) {
        ...
        header("Location: peers/peers.php");
        exit;
    } else {
...
//       $.ajax({
//         type: "POST",
//         url: "./services/user/authentication.php",
//         data: {
//           email: mayurigupta303@gmail.com,
//           password: password
//         },
...
//                 //set token in cookie
//                 setCookie("token", response.token, 1); // Set cookie with expiration of 1 day
...
//       } else {
//         console.log(message);
//         var messageBox = document.getElementById("login_title");
...
//           email.value = "";
//           email.classList.add("warning_box");
//         } else if (message === "Incorrect Password") {
//           password.value = "";
//           password.classList.add("warning_box");
//         }
//       }
//     }
...
//       var buttonIcon = $("#show-hide-button");
//       if (passwordInput.attr("type") === "password") {
//         passwordInput.attr("type", "text");
//         buttonIcon.html('<i class="bi bi-eye-slash-fill"></i>');
//         setTimeout(function() {
//           passwordInput.attr("type", "password");
//           buttonIcon.html('<i class="bi bi-eye-fill"></i>');
...
//   </script>
//   <script>
//     // function that is called when the page gets loaded and resized
//     function changeBg(){
//       //check the size of the window and if it is smaller than 767px
//       if(window.innerWidth < 767){
//         //change the source of the bgimg_box
//         document.getElementById("bgimg_box").src = "Calanjiaym-HRPortal-mobile-top.png";
//       }
//       else{
//         //change the source of the bgimg_box
//         document.getElementById("bgimg_box").src = "Calanjiaym-HRPortal.png";
//       }
//     }
...
//       } else {
//         var messageBox = document.getElementById("forgot_title");
//         messageBox.innerText = message;
//         messageBox.classList.add("warning");
//         var email = document.getElementById("femail");
//         if (message === "Incorrect Email") {
//           email.value = "mayurigupta303@gmail.com";
//           email.classList.add("warning_box");
//         }
//       }
//     }
...
//       xhr.open("POST", "setnewpasskey.php", true);
//       xhr.onreadystatechange = function() {
//         if (xhr.readyState === 4) {
//           // Hide the loading animation
//           loading.style.display = "none";
...
//       } else {
//         var messageBox = document.getElementById("otp_title");
//         messageBox.innerText = message;
//         messageBox.classList.add("warning");
...
//           newpassword.value = "";
//           newpassword.classList.add("warning_box");
//           confirmpassword.value = "";
//           confirmpassword.classList.add("warning_box");
//         }
//         else if(message === "Incorrect OTP"){
//           var otp = document.getElementById("otpbox");
//           otp.value = "";
//           otp.classList.add("warning_box");
//           newpassword.value = "";
//           confirmpassword.value = "";
//         }
//       }
//     }
  ...
  <script>
    // function forgotform() {
    //   //hide #login_Form and show #forgot_form
    //   document.getElementById("login_form").style.display = "none";
    //   document.getElementById("forgot_form").style.display = "block";
    // }

    // function loginform() {
    //   //hide #forgot_form and show #login_form
    //   document.getElementById("forgot_form").style.display = "none";
    //   document.getElementById("otp_form").style.display = "none";
    //   document.getElementById("login_form").style.display = "block";
    // }
  ...
  <script>
    ...
    //   var buttonIcon = $("#show-hide-button1");
    //   if (passwordInput.attr("type") === "password") {
    //     passwordInput.attr("type", "text");
    //     buttonIcon.html('<i class="bi bi-eye-slash-fill"></i>');
    //     setTimeout(function() {
    ...
    //   var buttonIcon = $("#show-hide-button2");
    //   if (passwordInput.attr("type") === "password") {
    //     passwordInput.attr("type", "text");
    //     buttonIcon.html('<i class="bi bi-eye-slash-fill"></i>');
    //     setTimeout(function() {
